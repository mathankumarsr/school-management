  ...
  return (
    <div className="min-h-screen bg-blue-50 p-4">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-3xl font-bold text-blue-800 mb-6">Classroom Configuration Management</h1>
              ...
              <table className="w-full min-w-[700px]">
                <thead className="bg-blue-50 sticky top-0">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-left text-sm font-semibold text-blue-800 min-w-[120px]">Class Number</th>
                    <th className="px-4 py-3 text-left text-sm font-semibold text-blue-800 min-w-[80px]">Block</th>
                    <th className="px-4 py-3 text-left text-sm font-semibold text-blue-800 min-w-[120px]">Floor</th>
