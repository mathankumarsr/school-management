...
interface MockApi {
  data: Partial<SchoolConfigForm> | null;
  isLoading: boolean;
...
type MockMutationTuple = [
  (data: any) => Promise<{ data: { success: boolean; logoUrl?: string } }>,
  { isLoading: boolean; error: null }
];

const SchoolConfig = () => {
  const [formData, setFormData] = useState<SchoolConfigForm>({
    schoolName: '',
    schoolCode: '',
    address: '',
    phoneNumber: '',
  ...
  const [errors, setErrors] = useState<SchoolConfigErrors>({});
  ...
  const mockMutation: MockMutationTuple = [
    async (data) => {
...
// const [uploadLogo, { isLoading: isUploadingLogo }] = useUploadLogoMutation();
  ...
  const handleInputChange = (e: ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
    const name = e.target.name as keyof SchoolConfigErrors; // cast it
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        if (typeof reader.result === 'string') {
          setLogoPreview(reader.result); // ✅ TypeScript happy
        }
      };
  ...
  return (
    <div className="bg-blue-50 py-3 px-4 lg:px-6 w-full relative">
      <div className="mb-3">
        <SettingsTabs />
      </div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 transition-all ${errors.schoolName
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 transition-all ${errors.schoolCode
                    ? 'border-red-300 focus:ring-red-500 focus:border-red-500'
                    : 'border-gray-300 focus:ring-blue-500 focus:border-blue-500'
                    }`}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 transition-all ${errors.establishedYear
                      ? 'border-red-300 focus:ring-red-500 focus:border-red-500'
                      : 'border-gray-300 focus:ring-blue-500 focus:border-blue-500'
                      }`}
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 transition-all resize-none ${errors.address
                    ? 'border-red-300 focus:ring-red-500 focus:border-red-500'
                    : 'border-gray-300 focus:ring-blue-500 focus:border-blue-500'
                    }`}
                  rows={4}
          ...
          <div className="flex items-start space-x-6">
            <div className="flex-shrink-0">
              <div className="w-40 h-40 border-2 border-dashed border-gray-300 rounded-lg flex items-center justify-center bg-white relative overflow-hidden shadow-sm">
                ...
                <label
                  htmlFor="logo-upload"
                  className="inline-flex items-center px-3 py-2 mt-2 border border-blue-300 rounded-lg shadow-sm text-sm font-medium text-blue-700 bg-white hover:bg-blue-50 cursor-pointer transition-colors"
                >
                  <Upload className="h-4 w-4 mr-2" />
                  {logoFile ? 'Change Logo' : 'Upload'}
                </label>
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 transition-all ${errors.phoneNumber
                      ? 'border-red-300 focus:ring-red-500 focus:border-red-500'
                      : 'border-gray-300 focus:ring-blue-500 focus:border-blue-500'
                      }`}
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 transition-all ${errors.website
                      ? 'border-red-300 focus:ring-red-500 focus:border-red-500'
                      : 'border-gray-300 focus:ring-blue-500 focus:border-blue-500'
                      }`}
