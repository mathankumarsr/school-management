...
const UserAccess: React.FC<UserAccessProps> = ({ from = '' }) => {
  ...
  navigate("/settings/screen-access", {
    state: {
  ...
  return (
    <div className=" bg-blue-50 py-3 px-4 lg:px-6 h-full w-full">
      ...
      <div className="bg-white p-6 h-[58.5vh] overflow-auto scrollbar-hide">
        {/* User Details Tab */}
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {modules.map((module) => {
                ...
                return (
                  <div key={module.name} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow flex justify-between items-center">
      ...
      <div className="bg-white flex justify-end space-x-4 p-4 border-t border-gray-200">
